...
def get_prop(filename):
	...
	if targ_DEC[0] == '-':
		dtype=[('RA','U5'),('DEC','U6'),('zq',float),('z',float),('b',float),('logM',float),('QSO_mag',float),('Sod_line',float)]
	
	if targ_DEC[0] != '-':
		dtype=[('RA','U5'),('DEC','U5'),('zq',float),('z',float),('b',float),('logM',float),('QSO_mag',float),('Sod_line',float)]
	
	prop=numpy.genfromtxt('/Users/ryan/Desktop/keck_spectra/target_list_jun.dat',
